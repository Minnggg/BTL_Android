        ...
        btnSua.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (tenNhiemVu.length()!=0){
                    mDbHelper.updateNhiemVu(model.ID_NhiemVu,new NhiemVuModel(tenNhiemVu,ghichu,giobatdau.getValue(),phutbatdau.getValue(),gioketthuc.getValue(),phutketthuc.getValue()));
                    update();
                    dialog.dismiss();
                }
                else {
...
//        phutketthuc.setTextColor(Color.parseColor("#FF0000")); // Đặt màu chữ thành màu đỏ
        btnThem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String ghichu = edghiChu.getText().toString().trim();
                if (tenNhiemVu.length()!=0){
                    intent = new Intent(QuanLyNhiemVuActivity.this,AlarmReceiver.class);
                    ...
                    calendar.set(Calendar.HOUR_OF_DAY, giobatdau.getValue()); // giờ (gio là biến chứa giá trị giờ)
                    calendar.set(Calendar.MINUTE, phutbatdau.getValue()); // phút (phut là biến chứa giá trị phút)
                    intent.setAction("MyAction");
                    intent.putExtra("ten",tenNhiemVu);
                    intent.putExtra("thoigian",giobatdau.getValue() + "h" +phutbatdau.getValue());

                    pendingIntent = PendingIntent.getBroadcast(
                            QuanLyNhiemVuActivity.this,0,intent,PendingIntent.FLAG_UPDATE_CURRENT
                    );
